...
const [theme, setTheme] = useState(false);
  ...
  function onSecondClick() {
    ref2.current.value = `Приятно познакомиться, я Бот Курт. А в какой стране ты проживаешь?`;
  }

  const ref3 = useRef("");
  function onThirdClick() {
    ref3.current.value = "Вау, я тоже оттуда! А какой город?";
  }
  const ref4 = useRef("");
...
return (
  ...
  <a className="group relative inline-flex overflow-hidden m-6 mx-auto  rounded border border-current px-14 py-3 text-indigo-600 focus:outline-none focus:ring active:text-indigo-500" href="/сhess">
    Шахматы
  </a>
</div>
