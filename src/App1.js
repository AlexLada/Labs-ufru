...
function App() {
  ...
  return (
      	...
      	<button className="flex w-1/4 h-7 justify-center my-auto text-center text-white rounded-md bg-violet-600 scale-95 hover:scale-105 transition-all transform duration-500" onClick={Split}>Разделить</button>
				...
				<div className="container flex mx-auto pt-10">
				<button className="flex mx-auto text-xs border-t-2 border-l-2 border-r-2 rounded-sm border-indigo-500" onClick={onClick}>Начать общение</button>
				</div>
				<div className="container text-xs flex mt-auto mx-auto flex-col h-2/3 w-1/2 border-2 rounded-lg border-indigo-500">
          
          <input className="flex my-auto ml-4 w-2/3 h-6 text-center text-white rounded-lg bg-indigo-500/40" ref={ref} disabled="disabled" />
					...
					<input className="flex my-auto ml-4 w-2/3 h-6 text-center text-white rounded-lg bg-indigo-500/40" ref={ref2} disabled="disabled"/>
					<div className="flex place-self-end space-x-0.5">
					...
					<input className="flex my-auto ml-4 w-2/3 h-6 text-center text-white rounded-lg bg-indigo-500/40" ref={ref3} disabled="disabled"/>
					<div className="flex place-self-end space-x-0.5">
					...
					<input className="flex my-auto ml-4 w-2/3 h-6 text-center text-white rounded-lg bg-indigo-500/40" ref={ref4} disabled="disabled"/>
					<div className="flex place-self-end space-x-0.5">
					...
					<input className="flex my-auto ml-4 w-2/3 h-6 text-center text-white rounded-lg bg-indigo-500/40" ref={ref5} disabled="disabled" />
